...
export function getResolvedCompilerOptions(options: Partial<AnalyserOptions> = {}): ResolvedCompilerOptions {
    const {compilerOptions, jsProject, tsConfigFilePath, include} = options;
